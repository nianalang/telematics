...
export default class Permission extends React.Component{
    ...
    requestList = ()=>{
        let _this = this;
        axios.ajax({
            url:'/telematis/admin/admin/findAllPermission',
            data:{
    ...
    handleRoleSubmit = ()=>{
        ...
        axios.ajax({
            url:'/telematis/admin/admin/insertPermission',
            data:{
                params:{
                    ...data
                }
    ...
    render(){
        ...
        return (
            <div>
                <Card>
                    <Button type="primary" onClick={this.handleRole} className="button">创建角色</Button>
                    <Button type="primary" onClick={this.handlePermission} className="button">设置权限</Button>
                    <Button type="primary" onClick={this.handleUserAuth} className="button">用户授权</Button>
                    <Table
